...
public final class ActivityCalendarBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView listCal;

  private ActivityCalendarBinding(@NonNull ConstraintLayout rootView, @NonNull ListView listCal) {
  ...
  public static ActivityCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.listCal;
      ListView listCal = ViewBindings.findChildViewById(rootView, id);
      if (listCal == null) {
        break missingId;
      }

      return new ActivityCalendarBinding((ConstraintLayout) rootView, listCal);
    }
