...
public final class ActivityScrollingBinding implements ViewBinding {
  ...
  private ActivityScrollingBinding(@NonNull ConstraintLayout rootView, @NonNull ListView list) {
  ...
  public static ActivityScrollingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScrollingBinding((ConstraintLayout) rootView, list);
    }
